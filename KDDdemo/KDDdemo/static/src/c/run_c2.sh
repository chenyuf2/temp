...
then
    ...
    ./word2vec -train ./${dataset}/cleaned.txt -output ./${dataset}/embedding_c_w.txt -context ./${dataset}/embedding_c_v.txt -kappa ./${dataset}/embedding_c_cap.txt -topic /shared/data/zihanw2/catem/countries.txt -topic_output ./${dataset}/embedding_c_t.txt -reg_lambda 1 -cbow 0 -size 100 -with_local 1 -global_lambda 1.5 -window 5 -negative 5 -sample 1e-3 -min-count 5 -threads 20 -binary 0 -iter 10 -pretrain 2 -rank_product 0 -gen_vocab 0 -load_emb 1
